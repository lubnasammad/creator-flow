...
class _BrandListScreenState extends State<BrandListScreen> {
  final _brandService = BrandCollaborationService();
  final _sessionManager = SessionManager();
  List<BrandCollaboration> _collaborations = [];
  ...
  Future<void> _loadData() async {
    ...
    if (_userId != null) {
      final collaborations = await _brandService.getAll(_userId!);
      setState(() {
              ...
              itemBuilder: (context, index) {
                ...
                return Dismissible(
                  ...
                  onDismissed: (direction) {
                    _brandService.delete(collaboration.id!);
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        final result = await Navigator.of(context).push<bool>(
                          MaterialPageRoute(
                            builder: (context) =>
                                AddBrandScreen(collaboration: collaboration),
                          ),
                        );
                        if (result == true) {
                          _loadData();
                            ...
                            Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      '\$${collaboration.payment.toStringAsFixed(2)}',
                                      style: Theme.of(context)
                                          .textTheme
                                          .titleLarge
                                          ?.copyWith(
